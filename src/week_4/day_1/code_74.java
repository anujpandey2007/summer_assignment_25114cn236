...
public class code_74 {
    ...
    public static void main(String[] args) {
        ...
        // 2. Initializing and filling the SECOND matrix
        ...
        int[][] resultMatrix = subtractMatrices(arr1, arr2);
